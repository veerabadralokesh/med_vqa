...
def main():
    ...
    llama_model = AutoModelForCausalLM.from_pretrained("meta-llama/Llama-2-7b-hf", load_in_8bit=True, device_map='auto', torch_dtype=torch.float16)
    tokenizer = AutoTokenizer.from_pretrained("meta-llama/Llama-2-7b-hf")
    # tokenizer = LlamaTokenizer.from_pretrained("/Users/arushisharma/Documents/projects/llama/llama-2-7b/ggml-model-f32_q4_0.gguf")
